1.Запуск проекту
1.1 Завантажити проект з Github архівом чи клонувати з репозиторію. Перейти в папку проекту
1.2 У кореневій папці проєкту встановлення залежностей (composer install)
1.3 Налаштувати файл .env
1.4 Виконати міграції 
